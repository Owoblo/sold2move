...
async function buildMarketWorkbook(lane, records, lifecycleEvents = []) {
...
<workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  <sheets><sheet name="${lane === 'rental' ? 'Rental Inventory' : 'Commercial Inventory'}" sheetId="1" r:id="rId1"/></sheets>
</workbook>`);
